...
const Carts = () => {
    ...
    console.log('cartAddToPayment', cartAddToPayment);
    return (
        <div className=''>
            ...
            {carts.length === 0 ? (
                <div className='w-full p-6 '>
                    <h1 className='text-xl font-medium text-center'>Giỏ hàng của bạn đang trống</h1>
                </div>)
                : (
                    <div className='grid grid-cols-5'>
                        <div className={`${cartAddToPayment.length === 0 ? 'col-span-4' : 'col-span-3'}`}>
                            <div className='p-6'>
                            ...
                            <div className={`flex flex-row`}>
                                <div className='px-6'>
                                    {carts.map(cart => {
                                        const product = cart.product;
                                        return (
                                            <div key={cart.id} className='grid grid-cols-6'>
